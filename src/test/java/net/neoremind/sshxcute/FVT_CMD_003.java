package net.neoremind.sshxcute;
 ...
 *
 */
public class FVT_CMD_003 extends TestCase {
	
	public void setUp() throws Exception {
		super.setUp();
	}

	public void testFVT_CMD_003()
	{
		SSHExec ssh = null;
		try {
			...
			CustomTask ct2 = new ExecCommand("ls -al");
			...
			assertEquals(r2.rc, 0);
			assertEquals(r3.rc, 0);
